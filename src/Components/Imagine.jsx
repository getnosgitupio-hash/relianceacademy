  ...
  return (
    <section className="relative flex sm:min-h-screen items-center justify-center overflow-hidden bg-black text-white py-10 lg:py-12">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 text-center">
        ...
        <button
          type="submit"
          className="mt-6 sm:mt-8 lg:mt-10 h-[48px] sm:h-[52px] lg:h-[56px] rounded-full bg-[#5338FF] px-6 sm:px-8 text-sm sm:text-base lg:text-lg font-semibold text-white shadow-[0_0_30px_rgba(83,56,255,0.5)] transition hover:scale-[1.01] hover:shadow-[0_0_40px_rgba(83,56,255,0.65)]"
        >
          Take The First Step
        </button>
